        ...
        $( document ).ready(function() {
            ...
            */
            ...
            .then((response)=> { 
                    ...
                    if(response.length) 
                       staticsHomeData = groupByWeek(response)

                   var bodyStatics = {
                        labels: ["Semana 1", "Semana 2", "Semana 3", "Semana 4", "Semana 5", "Semana 6", "Semana 8"],
                        datasets: [{//staticsHomeData
                            label: "Cupones Redimidos",
                            backgroundColor: window.chartColors.red,
                            data: [20, 40, 60, 80, 100, 80, 100]
                        }, {
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div> Token Analytics 
                                        <div class="page-title-subheading">Sigue el rendimientos y los resultados de las campañas que realizas.
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            ...
                                            <div class="widget-subheading">Clientes que siguen tu empresa</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span id="follower">0</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Correos</div>
                                            <div class="widget-subheading">Correos disponibles</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span id="numSms">0</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Mensajes de Texto</div>
                                            <div class="widget-subheading">Mensajes disponibles</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span id="numEmail">0</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Saldo total</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white">$<span id="saldoTotal">0</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form>
                                <script src='https://checkout.epayco.co/checkout.js'
                                    data-epayco-key='a5f59b88a7f37d382efe3daa643f7136'
                                    class='epayco-button'
                                    data-epayco-amount='100000'
                                    data-epayco-tax='0'
                                    data-epayco-tax-base='100000'
                                    data-epayco-name='Cuneta Token App'
                                    data-epayco-description='Cuneta Token App'
                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="d-block text-center card-footer">
                                        ...
                                        <button class="btn-wide btn btn-success">Recargar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
